...
## 3.5 AI 素养调节效应分析（交互回归 + 简单斜率）


### 3.5.1 自评能力（SAE）调节干预效果

> 模型：acc_total ~ group_c * sae_c + person-level controls（性别+年龄+学历五分法）
> sae_c = 前测自评能力（中心化）；group_c = 组别中心化（对照=−0.5，实验=0.5）
...
| 变量                               |        B |      SE |    Beta |       t |          p |    VIF |
|----------------------------------|----------|---------|---------|---------|------------|--------|
| (常量)                             |    0.598 |   0.028 |         |  21.501 |     < .001 |        |
| 组别（C=1）                          |    0.071 |   0.025 |   0.229 |   2.832 |     .005** |  1.093 | *
| 前测自评能力（中心化）                      |    0.049 |   0.014 |   0.361 |   3.383 |  < .001*** |  1.895 | *
| 交互：组别 x 自评能力                     |   -0.047 |   0.022 |  -0.234 |  -2.139 |      .034* |  1.999 | *
| 性别（女=1）                          |   -0.027 |   0.025 |         |  -1.070 |       .287 |  1.081 |
| 年龄 25-34（vs 18-24）               |    0.029 |   0.030 |         |   0.974 |       .332 |  1.242 |
| 年龄 35-44（vs 18-24）               |   -0.024 |   0.050 |         |  -0.492 |       .623 |  1.147 |
| 年龄 45-54（vs 18-24）               |   -0.011 |   0.037 |         |  -0.304 |       .762 |  1.271 |
| 学历 高中（vs 本科）                     |    0.032 |   0.048 |         |   0.651 |       .516 |  1.175 |
| 学历 大专（vs 本科）                     |    0.013 |   0.037 |         |   0.346 |       .730 |  1.332 |
| 学历 硕士（vs 本科）                     |    0.025 |   0.030 |         |   0.821 |       .413 |  1.319 |
| 学历 博士（vs 本科）                     |    0.045 |   0.049 |         |   0.918 |       .360 |  1.194 |

R2=0.160, Adj.R2=0.094, F(11,140)=2.429, p = .008**
因变量：acc_total（模型：自评能力调节）


**交互项（group_c × sae_c）**: t=-2.139, p=.034*
交互显著，表明自评能力调节了干预效果。

**按自评能力水平的简单斜率**：
| 自评能力水平  | β（组别） | SE    | t     | p         |
| ------- | ----- | ----- | ----- | --------- |
| 低（-1SD） | 0.125 | 0.036 | 3.515 | < .001*** |
| 中       | 0.071 | 0.025 | 2.832 | .005**    |
| 高（+1SD） | 0.017 | 0.036 | 0.492 | .624      |

### 3.5.2 AI 使用频率（AIE）调节干预效果

> 模型：acc_total ~ group_c * aie_c + person-level controls
> aie_c = AI 使用频率（中心化）
...
| 变量                               |        B |      SE |    Beta |       t |          p |    VIF |
|----------------------------------|----------|---------|---------|---------|------------|--------|
| (常量)                             |    0.588 |   0.028 |         |  20.740 |     < .001 |        |
| 组别（C=1）                          |    0.074 |   0.026 |   0.239 |   2.906 |     .004** |  1.083 | *
| AI使用频率（中心化）                      |    0.016 |   0.016 |   0.110 |   0.961 |       .338 |  2.095 |
| 交互：组别 x AI频率                     |    0.020 |   0.023 |   0.099 |   0.875 |       .383 |  2.058 |
| 性别（女=1）                          |   -0.022 |   0.026 |         |  -0.854 |       .394 |  1.079 |
| 年龄 25-34（vs 18-24）               |    0.030 |   0.030 |         |   1.021 |       .309 |  1.210 |
| 年龄 35-44（vs 18-24）               |   -0.015 |   0.051 |         |  -0.293 |       .770 |  1.158 |
| 年龄 45-54（vs 18-24）               |   -0.002 |   0.038 |         |  -0.051 |       .959 |  1.302 |
| 学历 高中（vs 本科）                     |    0.053 |   0.050 |         |   1.060 |       .291 |  1.188 |
| 学历 大专（vs 本科）                     |    0.008 |   0.038 |         |   0.207 |       .836 |  1.346 |
| 学历 硕士（vs 本科）                     |    0.023 |   0.031 |         |   0.758 |       .450 |  1.301 |
| 学历 博士（vs 本科）                     |    0.047 |   0.048 |         |   0.976 |       .331 |  1.135 |

R2=0.126, Adj.R2=0.057, F(11,140)=1.837, p = .053
因变量：acc_total（模型：使用频率调节）


**交互项（group_c × aie_c）**: t=0.875, p=.383
交互不显著，AI 使用频率未显著调节干预效果。

**按 AI 使用频率水平的简单斜率**：
| 使用频率水平  | β（组别） | SE    | t     | p      |
| ------- | ----- | ----- | ----- | ------ |
| 低（-1SD） | 0.052 | 0.036 | 1.440 | .152   |
| 中       | 0.074 | 0.026 | 2.906 | .004** |
| 高（+1SD） | 0.097 | 0.036 | 2.676 | .008** |

### 3.5.3 调节效应可视化（PROCESS 风格）


![AI素养调节效应](F_moderation_ai_literacy_v4.png)
